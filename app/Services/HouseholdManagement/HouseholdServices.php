...
class HouseholdServices
{
        ...
        return DB::transaction(function () use ($performedBy, $data, $headData) {
            ...
            try {
                ...
                $resident = $this->residentRepository->create([
                    ...
                    'nationality_id' => $headData['nationality_id'] ?? Resident::LOOKUP_UNSPECIFIED,
                    'religion_id' => $headData['religion_id'] ?? Resident::LOOKUP_UNSPECIFIED,
                    'ethnicity_id' => $headData['ethnicity_id'] ?? Resident::LOOKUP_UNSPECIFIED,
    ...
    public function formatRecord(Household $household, bool $includeResidents = false): array
    {
        ...
        if ($includeResidents) {
            $household->loadMissing([
                ...
                'residents.migration.residentType',
                'residents.status',
                'residents.clan',
    ...
    private function formatResident(Resident $resident): array
    {
        return [
            ...
            'resident_type_id' => $resident->migration?->resident_type_id,
            'resident_type' => $resident->migration?->residentType?->resident_type,
