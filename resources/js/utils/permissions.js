...
const PERMISSION_LABELS = {
    ...
    'education.view': { group: 'Education', label: 'View education records' },
    'education.create': { group: 'Education', label: 'Create education records' },
    'edcuation.update': { group: 'Education', label: 'Update education records' },
    'economic.view': { group: 'Economic', label: 'View economic records' },
    'economic.create': { group: 'Economic', label: 'Create economic records' },
    'economic.update': { group: 'Economic', label: 'Update economic records' },
    'infanthealth.view': { group: 'Infant health', label: 'View infant health records' },
    'infanthealth.create': { group: 'Infant health', label: 'Create infant health records' },
    'infanthealth.update': { group: 'Infant health', label: 'Update infant health records' },
    'health.view': { group: 'Health', label: 'View health records' },
    'health.create': { group: 'Health', label: 'Create health records' },
    'health.update': { group: 'Health', label: 'Update health records' },
    'womenhealth.view': { group: 'Women\'s health', label: 'View women\'s health records' },
    'womanhealth.create': { group: 'Women\'s health', label: 'Create women\'s health records' },
    'womanhealth.update': { group: 'Women\'s health', label: 'Update women\'s health records' },
    'sociocivic.view': { group: 'Sociocivic', label: 'View sociocivic records' },
    'sociocivic.create': { group: 'Sociocivic', label: 'Create sociocivic records' },
    'sociocivic.update': { group: 'Sociocivic', label: 'Update sociocivic records' },
    'migration.view': { group: 'Migration', label: 'View migration records' },
    'migration.create': { group: 'Migration', label: 'Create migration records' },
    'migration.update': { group: 'Migration', label: 'Update migration records' },
    'ctc.view': { group: 'Community tax certificate', label: 'View community tax certificates' },
    'ctc.create': { group: 'Community tax certificate', label: 'Create community tax certificates' },
    'ctc.update': { group: 'Community tax certificate', label: 'Update community tax certificates' },
